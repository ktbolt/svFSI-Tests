...
#$comp iterate_solution_0_Ao_init_cm.bin ITERATE_SOLUTION_0_Ao_init_fm.bin 
#$comp iterate_solution_0_Do_init_cm.bin ITERATE_SOLUTION_0_Do_init_fm.bin 
#$comp iterate_solution_0_Yo_init_cm.bin ITERATE_SOLUTION_0_Yo_init_fm.bin 

#$comp iterate_solution_0_An_init_cm.bin ITERATE_SOLUTION_0_An_init_fm.bin 
#$comp iterate_solution_0_Dn_init_cm.bin ITERATE_SOLUTION_0_Dn_init_fm.bin 
#$comp iterate_solution_0_Yn_init_cm.bin ITERATE_SOLUTION_0_Yn_init_fm.bin 

#$comp cep_integ_0_sF_cm.bin CEPINTEG_0_sF_fm.bin 
#$comp cep_integ_0_sA_cm.bin CEPINTEG_0_sA_fm.bin 
...
#$comp cep_integ_0_Xion_cm.bin CEPINTEG_0_Xion_fm.bin
#$comp cep_integ_0_Yo_cm.bin CEPINTEG_0_Yo_fm.bin
